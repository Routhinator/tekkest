...
-- no float
	if ENABLE_WALKERS then
		...
		mobs:register_egg("crocodile:crocodile", "Crocodile", l_egg_texture, 1)
	end
...
-- float
	if ENABLE_FLOATERS then
		...
		mobs:register_egg("crocodile:crocodile_float", "Crocodile (floater)", l_egg_texture, 1)
	end
...
-- swim
	if ENABLE_SWIMMERS then
		...
		mobs:register_egg("crocodile:crocodile_swim", "Crocodile (swimmer)", l_egg_texture, 1)
	end
